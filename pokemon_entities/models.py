...
class PokemonEntity(models.Model):
    ...
    health = models.IntegerField(default=None, verbose_name='Очки жизни')
    strength = models.IntegerField(default=None, verbose_name='Очки силы')
    defense = models.IntegerField(default=None, verbose_name='Очки защиты')
    stamina = models.IntegerField(default=None, verbose_name='Очки выносливости')
